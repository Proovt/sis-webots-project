...
/**
 * @brief      Compute wheel speeds using Braitenberg architecture
 * @param[in]  ps         Array of proximity sensor values
 * @param[out] lws        Left wheel speed (output)
 * @param[out] rws        Right wheel speed (output)
 */
