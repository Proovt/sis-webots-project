...
plt.plot(time, sigma_x, label='X Uncertainty ($1 \sigma$)', color='blue', linestyle='--')
plt.plot(time, error_y, label='Y Error', color='orange')
plt.plot(time, sigma_y, label='Y Uncertainty ($1 \sigma$)', color='orange', linestyle='--')
...
plt.plot(time, 3 * sigma_heading, label='Heading Uncertainty ($3 \sigma$)', color='dodgerblue', linestyle='--')
